...
class AddRecordForm(forms.ModelForm):
    ...
    zip_code = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Zip Code'}), required=True)

    class Meta:
        model = Record
        # This will add all the fields from the model
        exclude = ("user",)